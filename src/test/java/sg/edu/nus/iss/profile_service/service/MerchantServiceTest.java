...
//        when(merchantRepository.findByIdAndDeletedFalse(merchantId)).thenReturn(Optional.of(merchant));
...
//        when(merchantRepository.findByEmailAndDeletedFalse("test@example.com")).thenReturn(Optional.of(merchant));
